    ...
    <article class="group hover:shadow-lg transition-all relative flex items-stretch rounded-2xl ring-1 ring-gray-200 bg-white overflow-hidden">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="' . esc_url($website) . '" target="_blank" rel="noopener"
               class="underline break-all text-[#0B284D] hover:opacity-80 transition-all md:block hide-plugin">' . esc_html($website) . '</a>
        </div>' : '' ) . '
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="' . esc_url($facebook) . '" target="_blank" rel="noopener"
               class="underline break-all text-[#0B284D] hover:opacity-80 transition-all md:block hide-plugin">' . esc_html($facebook) . '</a>
        </div>' : '' ) . '
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="tel:' . esc_attr(preg_replace("/\D+/", "", $phone)) . '" class="">
                <span class=" text-[#0B284D] hover:opacity-80 transition-all md:block hide-plugin">' . esc_html($phone) . '</span>
            </a>
        </div>' : '' ) . '
