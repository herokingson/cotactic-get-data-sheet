                ...
                <div class="flex-1 px-3 py-[4px] md:py-[7px] text-left">
                 ...
                 <div class="flex pl-2 min-h-[50px] !border-t !border-t-[rgb(229_231_235)]" style="border-top: 1px solid rgb(229 231 235);">
                   <div class="flex flex-row flex-wrap items-center gap-x-5 md:gap-x-3 gap-y-1 text-sm">
                      ' . ($website ? '<a href="' . esc_url($website) . '" target="_blank" class="flex items-center gap-2 text-[#0B284D] hover:opacity-80 transition-all"><img src="' . plugins_url('dist/images/website-icon.svg', __FILE__) . '" alt="Website" class="w-[18px] h-[18px]" /><span class="underline break-all text-[13px] font-sarabun hidden md:block">Website</span></a>' : '') . '
                      ' . ($facebook ? '<a href="' . esc_url($facebook) . '" target="_blank" class="flex items-center gap-2 text-[#0B284D] hover:opacity-80 transition-all"><img src="' . plugins_url('dist/images/facebook-icon.svg', __FILE__) . '" alt="Facebook" class="w-[18px] h-[18px]" /><span class="underline break-all text-[13px] font-sarabun hidden md:block">Facebook</span></a>' : '') . '
                      ' . ($website ? '<a href="https://www.google.com/maps/search/' . urlencode($agency) . '" target="_blank" class="flex items-center gap-2 text-[#0B284D] hover:opacity-80 transition-all"><img src="' . plugins_url('dist/images/direction-icon.svg', __FILE__) . '" alt="Direction" class="w-[18px] h-[18px]" /><span class="underline break-all text-[13px] font-sarabun hidden md:block">Direction</span></a>' : '') . '
                      ' . ($phone ? '<a href="tel:' . preg_replace('/\\D+/', '', $phone) . '" class="flex items-center gap-2 text-[#0B284D] hover:opacity-80 transition-all"><img src="' . plugins_url('dist/images/call-icon.svg', __FILE__) . '" alt="Phone" class="w-[18px] h-[18px]" /><span class="underline break-all text-[13px] font-sarabun hidden md:block">' . esc_html($phone) . '</span></a>' : '') . '
                        ' . (($caption || $contact) ? '
                  </div>
                  <div class="ml-auto">
